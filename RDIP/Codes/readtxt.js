...
function cs(){
    ...
    for(let i=0;i<newArray.length;i++){
        ...
        if (n == 0) {
            document.getElementById('s8').innerHTML = "This is the Right answer";
            
            return;
        }
    }
    document.getElementById('ptag9').innerHTML = "This is the wrong answer";
...
if (selection.value=='english'){
        ...
        document.getElementById('ptag10').innerHTML = "<center><button id='showansbtn' onclick='hs()'>hide correct answer</button></center>"
...
function fs(id,value){
    ...
    fin += value + " ";
     document.getElementById("s5").innerHTML = fin;
...
function rs(){
  ...
  fin = "";
    ...
    document.getElementById('ptag10').innerHTML="";
    document.getElementById("s4").innerHTML = "";
    document.getElementById("s8").innerHTML = "";
    document.getElementById("ptag9").innerHTML = "";
    cc=0;
}
